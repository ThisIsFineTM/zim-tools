...
TEST(zimfilechecks, test_articles)
{
  ...
  EnabledTests all_checks;
  all_checks.enableAll();
...
class CapturedStdStream
{
 ...
 public:
  explicit CapturedStdStream(std::ostream& os) : stream(os), sbuf(os.rdbuf())
  {
  ...
  ~CapturedStdStream() { stream.rdbuf(sbuf); }
...
struct CmdLine : CmdLineImpl {
  CmdLine(const std::initializer_list<value_type>& il) : CmdLineImpl(il) {}
};
...
TEST(zimcheck, integrity_goodzimfile)
{
  ...
  test_zimcheck_single_option(
      {"-I", "--integrity"}, GOOD_ZIMFILE, 0, expected_output, EMPTY_STDERR);
}
...
TEST(zimcheck, checksum_goodzimfile)
{
  const std::string expected_output(
      ...
      "[INFO] Zimcheck version is " VERSION
      "\n"
      "[WARNING] Integrity check is skipped. Any detected errors may in fact "
      "be due to corrupted/invalid data.\n"
  ...
  test_zimcheck_single_option(
      {"-C", "--checksum"}, GOOD_ZIMFILE, 0, expected_output, EMPTY_STDERR);
}
...
TEST(zimcheck, metadata_goodzimfile)
{
  ...
  test_zimcheck_single_option(
      {"-M", "--metadata"}, GOOD_ZIMFILE, 0, expected_output, EMPTY_STDERR);
}
...
TEST(zimcheck, favicon_goodzimfile)
{
  ...
  test_zimcheck_single_option(
      {"-F", "--favicon"}, GOOD_ZIMFILE, 0, expected_output, EMPTY_STDERR);
}
...
TEST(zimcheck, mainpage_goodzimfile)
{
  ...
  test_zimcheck_single_option(
      {"-P", "--main"}, GOOD_ZIMFILE, 0, expected_output, EMPTY_STDERR);
}
...
TEST(zimcheck, article_content_goodzimfile)
{
  ...
  test_zimcheck_single_option(
      {
          "-0",
          "--empty",  // Any of these options triggers
          "-U",
          "--url_internal",  // checking of the article contents.
          "-X",
          "--url_external"  // For a good ZIM file there is no
...
TEST(zimcheck, redundant_articles_goodzimfile)
{
  ...
  test_zimcheck_single_option(
      {"-R", "--redundant"}, GOOD_ZIMFILE, 0, expected_output, EMPTY_STDERR);
}
...
TEST(zimcheck, redirect_loop_goodzimfile)
{
  ...
  test_zimcheck_single_option({"-L", "--redirect_loop"},
                              GOOD_ZIMFILE,
                              0,
                              expected_output,
                              EMPTY_STDERR);
...
const std::string ALL_CHECKS_OUTPUT_ON_GOODZIMFILE(
    ...
    "[INFO] Verifying ZIM-archive structure integrity..."
    "\n"
    "[INFO] Avoiding redundant checksum test (already performed by the "
    "integrity check)."
    "\n"
    "[INFO] Checking metadata..."
    "\n"
...
{
  test_zimcheck_single_option({"-A", "--all"},
                              GOOD_ZIMFILE,
                              0,
...
{
  CapturedStdout zimcheck_output;
  ASSERT_EQ(0, zimcheck({"zimcheck", "--json", "data/zimfiles/good.zim"}));
...
TEST(zimcheck, bad_checksum)
{
  ...
  test_zimcheck_single_option({"-C", "--checksum"},
...
TEST(zimcheck, metadata_poorzimfile)
{
  ...
  test_zimcheck_single_option(
      {"-M", "--metadata"}, POOR_ZIMFILE, 1, expected_stdout, EMPTY_STDERR);
}
...
TEST(zimcheck, favicon_poorzimfile)
{
  ...
  test_zimcheck_single_option(
      {"-F", "--favicon"}, POOR_ZIMFILE, 1, expected_stdout, EMPTY_STDERR);
}
...
TEST(zimcheck, mainpage_poorzimfile)
{
  ...
  test_zimcheck_single_option(
      {"-P", "--main"}, POOR_ZIMFILE, 1, expected_stdout, EMPTY_STDERR);
}
...
TEST(zimcheck, empty_items_poorzimfile)
{
  ...
  test_zimcheck_single_option(
      {"-0", "--empty"}, POOR_ZIMFILE, 1, expected_stdout, EMPTY_STDERR);
}
...
TEST(zimcheck, internal_url_check_poorzimfile)
{
  ...
  test_zimcheck_single_option(
      {"-U", "--url_internal"}, POOR_ZIMFILE, 1, expected_stdout, EMPTY_STDERR);
}
...
TEST(zimcheck, external_url_check_poorzimfile)
{
  const std::string expected_stdout(
      ...
      "\n"
      "  http://a.io/pic.png is an external dependence in article "
      "external_image_http.html"
      "\n"
      "  https://a.io/pic.png is an external dependence in article "
      "external_image_https.html"
      "\n"
      "  //a.io/pic.png is an external dependence in article "
  ...
  test_zimcheck_single_option(
      {"-X", "--url_external"}, POOR_ZIMFILE, 1, expected_stdout, EMPTY_STDERR);
}
...
TEST(zimcheck, redundant_poorzimfile)
{
  ...
  test_zimcheck_single_option(
      {"-R", "--redundant"}, POOR_ZIMFILE, 0, expected_stdout, EMPTY_STDERR);
}
...
TEST(zimcheck, json_bad_checksum)
{
  ...
  ASSERT_EQ(
      1,
      zimcheck({"zimcheck", "--json", "-C", "data/zimfiles/bad_checksum.zim"}));
  ...
  ASSERT_EQ(
      ...
      "      \"level\" : \"ERROR\","
      "\n"
      "      \"message\" : \"ZIM Archive Checksum in archive: "
...
TEST(zimcheck, json_poorzimfile)
{
  ...
  ASSERT_EQ(
      ...
      "      \"level\" : \"ERROR\","
      "\n"
      "      \"message\" : \"Missing mandatory metadata: "
      ...
      "      \"level\" : \"ERROR\","
      "\n"
      "      \"message\" : \"Language doesn't match regex: "
      "^\\\\w{3}(,\\\\w{3})*$\","
      "\n"
      "      \"error\" : \"Language doesn't match regex: "
      "^\\\\w{3}(,\\\\w{3})*$\""
      "\n"
      "    },"
      "\n"
      ...
      "      \"level\" : \"ERROR\","
      "\n"
      "      \"message\" : \"Main Page Index stored in Archive Header: "
      "4294967295\","
      "\n"
      ...
      "A/non_existent.html\\n(A/non_existent.html) were not found in article "
      "dangling_link.html\","
      "\n"
      "      \"links\" : ["
      "\n"
      ...
      "      \"level\" : \"ERROR\","
      "\n"
      "      \"message\" : \"../../oops.html is out of bounds. Article: "
      "outofbounds_link.html\","
      "\n"
      "      \"link\" : \"../../oops.html\","
      "\n"
      ...
      "      \"level\" : \"ERROR\","
      "\n"
      "      \"message\" : \"http://a.io/pic.png is an external dependence in "
      "article external_image_http.html\","
      "\n"
      ...
      "      \"level\" : \"ERROR\","
      "\n"
      "      \"message\" : \"https://a.io/pic.png is an external dependence in "
      "article external_image_https.html\","
      "\n"
      ...
      "      \"level\" : \"ERROR\","
      "\n"
      "      \"message\" : \"//a.io/pic.png is an external dependence in "
      "article external_image_protocol_relative.html\","
      "\n"
      "      \"link\" : \"//a.io/pic.png\","
      "\n"
      ...
      "      \"level\" : \"ERROR\","
      "\n"
      "      \"message\" : \"Redirect loop exists from entry "
      "redirect_loop.html\\n\","
      "\n"
