...
#ifndef ZIM_JSON_TOOLS_H_
#define ZIM_JSON_TOOLS_H_
...
class OutputStream
{
 public:  // functions
  ...
  [[nodiscard]] bool enabled() const { return m_out != nullptr; }
 ...
 private:  // functions
  [[nodiscard]] const char* sep() const;
  ...
  template <class T>
  void output(const Property<T>& p);
